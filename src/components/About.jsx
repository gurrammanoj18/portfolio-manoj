  ...
  return (
    <div id='SectionAbout' className='about-div'>
        ...
        <div className='service'>
            ...
            <img src='https://cdn.sanity.io/images/599r6htc/regionalized/5094051dac77593d0f0978bdcbabaf79e5bb855c-1080x1080.png?w=540&h=540&q=75&fit=max&auto=format' alt='img' className='service-logo'/>
        ...
        <div className='service'>
             <img src='https://img.freepik.com/premium-vector/front-end-logo-design_717549-4108.jpg' alt='img'  className='service-logo'/>
            <div className='service-div'>
        ...
        <div className='service'>
            <img src='https://as2.ftcdn.net/jpg/04/75/01/75/1000_F_475017553_91jWgCknT2GQncXLNq5Kcv5I9veccR2Z.jpg'  alt='img' className='service-logo'/>
            <div className='service-div'>
